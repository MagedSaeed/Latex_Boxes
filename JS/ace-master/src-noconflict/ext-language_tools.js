...
//look only for keywords starting with \\
var ID_REGEX = /[\\]/;
...
(function() {
    ...
    this.insertMatch = function(data, options) {
        ...
        //changed
        //var curr_pos = this.editor.getCursorPosition();
        //this.editor.getSelection().selectionLead.setPosition(curr_pos.row,curr_pos.column-data.value.length+find_caret_pos(data.value)-1);
